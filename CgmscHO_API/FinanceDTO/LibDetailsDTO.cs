...
namespace CgmscHO_API.FinanceDTO
{
    public class LibDetailsDTO
    {
        ...
        public Decimal? LibValueasPerREC { get; set; }
        public Decimal? LibValueasPerRECLAcs { get; set; }

        public Decimal? LibValueasPerPO { get; set; }
        public Decimal? PipeLIvalue { get; set; }
        public Decimal? PipeLIvalueLAcs { get; set; }
